...
from torchvision.transforms import Normalize, Compose, RandomResizedCrop, InterpolationMode, ToTensor, Resize, \
    CenterCrop, ColorJitter, Grayscale, RandomHorizontalFlip, RandomVerticalFlip, RandomRotation
...
def image_transform(
    ...
    if is_train:
        ...
        if use_timm:
            ...
            train_transform.extend([RandomHorizontalFlip(p=0.5)])
            train_transform.extend([RandomVerticalFlip(p=0.5)])
            train_transform.extend([RandomRotation(90)])
